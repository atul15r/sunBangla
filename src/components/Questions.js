...
import { pushQuestion, questionsList } from "../redux/actions/dataActions";
			...
			<Grid container justify='center' alignItems='center'>
							...
							<Table.Row id='bR'>
								...
								<Table.Cell>
									...
									<Dropdown
										...
										value={ans_phone}
										options={
											name === "nandini" || name === "jiyonkathi"
												? answer1
												: name === "singhalagna" || name === "kone bou"
												? answer2
												: name === "beder meye jyotsna" ||
												  name === "sarbamangala"
												? answer3
												: answer
										}
				...
				{qL.length > 0 && (
					<Grid container justify='center' className={classes.csvSearch}>
						<Grid xs={1} md={2} lg={2} style={{ position: "relative" }}>
							{" "}
							<CSVLink data={qL} filename='AllQuestionList.csv'>
								<Chip
									id='csv'
									icon={
										<Icon
						...
						<Grid xs={10} md={2} lg={2}>
							<div className='ui icon input' style={{ width: "100%" }}>
								...
								<i
									...
									style={{ color: theme ? "#e45c37" : "#ccc", opacity: 1 }}
								></i>
							</div>
						</Grid>
					</Grid>
