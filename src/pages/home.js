...
export default function SwipeableTemporaryDrawer() {
	...
	const comp = comp => {
		...
		switch (comp) {
			case "Dashboard":
				document.title = comp + " - Sun Bangla";
				return <Dashboard />;
			case "Winners":
				document.title = comp + " - Sun Bangla";
				return <Winners />;
			...
			case "Addwinner":
				...
				return <AddWinner />;
			default:
				document.title = "Dashboard - Sun Bangla";
				return <Dashboard />;
		}
	};
		...
		>
			...
			<List>
				...
				<ListItem
					...
					className={clsx(classes.list, {
						[classes.listRespTheme]: values.comp === "Winners" && themeActive,
					...
					<ListItemIcon>
						<Icon
							...
							className={clsx(classes.icon, {
								...
								[classes.iconResp]: values.comp === "Winners" && !themeActive,
							})}
						/>
					</ListItemIcon>
					<ListItemText
				...
				<ListItem
					...
					className={clsx(classes.list, {
						...
						[classes.listResp]: values.comp === "Allcallers" && !themeActive,
					})}
				>
					<ListItemIcon>
						<PhoneCallbackIcon
				...
				<ListItem
					...
					className={clsx(classes.list, {
						[classes.listRespTheme]: values.comp === "Questions" && themeActive,
					...
					<ListItemIcon>
						<ContactSupportIcon
							className={clsx(classes.icon, {
								...
								[classes.iconResp]: values.comp === "Questions" && !themeActive,
							})}
						/>
					</ListItemIcon>
					<ListItemText
				...
				<ListItem
					...
					className={clsx(classes.list, {
						[classes.listRespTheme]: values.comp === "Addwinner" && themeActive,
					...
					<ListItemIcon>
						<AddCircleIcon
							className={clsx(classes.icon, {
								...
								[classes.iconResp]: values.comp === "Addwinner" && !themeActive,
							})}
						/>
					</ListItemIcon>
					<ListItemText
			...
			<div className={classes.footer}>
				...
				<img
					...
					style={{ width: 13, marginBottom: -3, marginLeft: 2 }}
				/>
			</div>
		</div>
	);
				...
				<Toolbar>
					...
					>
						<MenuIcon
							...
							style={{ color: themeActive ? "#fff" : "#f17547" }}
						/>
					</IconButton>
					<IconButton
						color='inherit'
